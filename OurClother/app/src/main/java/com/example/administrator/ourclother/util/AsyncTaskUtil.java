...
public class AsyncTaskUtil extends AsyncTask<String, Double, Boolean> {
    ...
    private com.example.administrator.ourclother.util.AsyncTaskRunnable mRunnable;
    ...
    public AsyncTaskUtil(Context context, Handler handler) {
        ...
        mRunnable = new com.example.administrator.ourclother.util.AsyncTaskRunnable(mContext);
    }
